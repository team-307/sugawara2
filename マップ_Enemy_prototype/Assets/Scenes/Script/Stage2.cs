...
public class Stage2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            SceneManager.LoadScene("map2-1", LoadSceneMode.Single);
        }
        if (Input.GetKeyDown(KeyCode.Alpha2))
        {
            SceneManager.LoadScene("map2-2", LoadSceneMode.Single);
        }
        if (Input.GetKeyDown(KeyCode.Alpha3))
        {
            SceneManager.LoadScene("map2-3", LoadSceneMode.Single);
        }
